...
namespace FinalProjectMvc.Migrations
{
    ...
    [Migration("20250627194137_CreateMessageTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinalProjectMvc.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinalProjectMvc.Models.Message", b =>
                {
                    b.HasOne("FinalProjectMvc.Models.AppUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FinalProjectMvc.Models.AppUser", "Sender")
                        .WithMany()
